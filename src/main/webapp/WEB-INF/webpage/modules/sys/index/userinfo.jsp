    ...
    <shiro:user>
        <div id="user-navbar" class="navbar">
            <ul class="nav btn-group">
                    ...
                    <div class="content">
                        <div class="loading">
                            ...
                            <div class="popover-content list">
                                <img src="${adminPath}/static/images/loading.gif" width="20px">&nbsp;&nbsp;&nbsp;加载中...
                            </div>
                        </div>
                ...
                <li class="btn">
                    <a href="${adminPath}/logout" data-toggle="tooltip" data-placement="bottom" title="退出"><i class="icon-large icon-signin"></i></a>
                </li>
            </ul>
        </div>
    </shiro:user>

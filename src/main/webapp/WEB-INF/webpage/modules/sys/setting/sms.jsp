       ...
       <div class="row">
            <div class="col-sm-12">
                <div class="col-sm-6">
	                <div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h5>云通讯配置 <a href="http://www.yuntongxun.com/" target="_blank">http://www.yuntongxun.com/</a></h5>
                ...
                <div class="col-sm-6">
	                <div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h5>互亿无线 <a href="http://www.ihuyi.com/" target="_blank">http://www.ihuyi.com/</a></h5>
	                        <div class="ibox-tools">
	                            <a class="collapse-link">
	                                <i class="fa fa-chevron-up"></i>
	                            </a>

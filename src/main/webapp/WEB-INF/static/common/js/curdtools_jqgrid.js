 ...
 * @return
 */
function deleteALLSelect(title,url,gridId) {
	var ids = [];
 ...
 * @return
 */
function toolbarConfirm(title,url,gridId,tipMsg) {
 ...
 * @return
 */
function delObj(title,url,infoid,gridId) {
	   swal({
            title: "提示",
            text: "您确定要删除这些信息么，请谨慎操作！",
            type: "warning",

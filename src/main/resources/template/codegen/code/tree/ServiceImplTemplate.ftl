...
public class ${entityName?cap_first}ServiceImpl  extends TreeCommonServiceImpl<${entityName?cap_first}Entity,String> implements  I${entityName?cap_first}Service {

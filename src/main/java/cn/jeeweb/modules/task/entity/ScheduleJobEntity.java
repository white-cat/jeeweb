...
public class ScheduleJobEntity extends AbstractEntity<String> {
	...
	private String id;
	/**更新者*/
	@Column(name ="update_by",nullable=true,length=64,scale=0)
	...
	/**创建者*/
	@Column(name ="create_by",nullable=true,length=64,scale=0)

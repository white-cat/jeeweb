package cn.jeeweb.modules.testtest.entity;
...
public class TestOrderCustomerEntity extends AbstractEntity<String> {
	...
	private String id;
    /**order_id*/
	private TestOrderMainEntity order;
    /**客户姓名*/
	private String name;
    /**创建时间*/
	...
	/**
	 * 获取  order
	 *@return: TestOrderMainEntity  order_id
	 */
	@JsonIgnore
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "order_id")
	public TestOrderMainEntity getOrder(){
		return this.order;
	}
	 ...
	 */
	public void setOrder(TestOrderMainEntity order){
		this.order = order;
	}
	/**
	 * 获取  name

...
public class DefaultGenerator implements IGenerator {
	...
	protected String getOutPath(GeneratorInfo generatorInfo) {
		...
		/*
		 * String subModuleName = generatorInfo.getSubModuleName(); if
		 * (!"".endsWith(subModuleName)) { outPath +=File.pathSeparator +
		 * subModuleName; }
		 */
		//
	...
	public void generate(GeneratorInfo generatorInfo, Map<String, Object> dataMap)
		...
		FreeMarkerUtils.initByDefaultTemplate().processToFile(ftl, dataMap, outFile.getAbsolutePath());
	}

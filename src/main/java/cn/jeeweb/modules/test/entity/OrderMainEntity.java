...
public class OrderMainEntity extends AbstractEntity<String> {
	...
	@JsonIgnore
	private List<OrderCustomerEntity> orderCustomerList = new ArrayList<OrderCustomerEntity>();

	@JsonIgnore
	private List<OrderTicketEntity> orderTicketList = new ArrayList<OrderTicketEntity>();
	 ...
	 * @return: Double 订单金额
	 */
	@Column(name = "money", nullable = false, length = 5, scale = 2)
	...
	public List<OrderCustomerEntity> getOrderCustomerList() {
		return orderCustomerList;
	}

	public void setOrderCustomerList(List<OrderCustomerEntity> orderCustomerList) {
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "orderMain")
	@Fetch(FetchMode.SELECT)
	public List<OrderTicketEntity> getOrderTicketList() {
		return orderTicketList;
	}

	public void setOrderTicketList(List<OrderTicketEntity> orderTicketList) {
